...
options_dict = {
    ...
    'trn_data_file': '/content/drive/My Drive/BT_data/dev_dataset_csv/train_set.csv',
    'val_data_file': '/content/drive/My Drive/BT_data/dev_dataset_csv/val_set.csv',
...
with torch.cuda.device(options_dict['gpu_idx']):
    ...
    torch.save(net.state_dict(), '/content/drive/My Drive/BT_data/model.pth')
    ...
    if options_dict['prog_plot']:
        ...
        plt.grid(True)
        plt.legend()
        plt.savefig('/content/drive/My Drive/BT_data/output_accuracy.png')
        plt.show()
